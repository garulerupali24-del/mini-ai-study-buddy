...
The application can be deployed using Streamlit Cloud or similar web application hosting platforms.
...
MSS's College of Engineering and Technology, Jalna (Affiliated to Dr. B.A.T. University, Lonere)      
